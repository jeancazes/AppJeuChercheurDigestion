-- ============================================
-- INSTALLATION PROPRE - Le Laboratoire Fabuleux
-- ============================================
-- Ce script nettoie tout et réinstalle proprement
-- Exécuter dans Supabase SQL Editor
-- ============================================

-- ÉTAPE 1 : NETTOYER (supprimer tables existantes si elles existent)
-- ============================================
...
-- Table RESOURCES (id en TEXT pour r1, r2, r3...)
...
-- Table PURCHASED_RESOURCES (resource_id en TEXT pour correspondre à resources.id)
...
CREATE TABLE team_member_sessions (
  ...
  session_1 VARCHAR(3) DEFAULT 'NN' CHECK (session_1 IN ('0','1','2','3','4','5','ABS','NN')),
  session_2 VARCHAR(3) DEFAULT 'NN' CHECK (session_2 IN ('0','1','2','3','4','5','ABS','NN')),
  session_3 VARCHAR(3) DEFAULT 'NN' CHECK (session_3 IN ('0','1','2','3','4','5','ABS','NN')),
  session_4 VARCHAR(3) DEFAULT 'NN' CHECK (session_4 IN ('0','1','2','3','4','5','ABS','NN')),
  session_5 VARCHAR(3) DEFAULT 'NN' CHECK (session_5 IN ('0','1','2','3','4','5','ABS','NN')),
  session_6 VARCHAR(3) DEFAULT 'NN' CHECK (session_6 IN ('0','1','2','3','4','5','ABS','NN')),
  created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
  updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
...
SELECT 
  '✅ Installation réussie !' as message,
  (SELECT COUNT(*) FROM classes) as classes,
  (SELECT COUNT(*) FROM teams) as teams,
  (SELECT COUNT(*) FROM resources) as resources,
  (SELECT COUNT(*) FROM purchased_resources) as achats;
